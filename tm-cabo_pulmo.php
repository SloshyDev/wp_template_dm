    ...
    <div class="w-[97%] mx-auto md:w-4/5 md:px-0">
        <div class="md:justify-start flex items-center gap-2 md:gap-4 md:ml-2 2xl:ml-8 mb-2">
            ...
            <h1 class="MBlackCondensed text-[5.5vw] md:text-4m text-[#4c7738]">
				<?php  echo _e('DATE ESTABLISHED: <span class="text-[#aeb521]">June 6, 1995</span>','dm'); ?>
            </h1>
        </div>
        ...
        <div
            ...
            <div class="flex items-center gap-[2vw] md:gap-4 xl:ml-2 2xl:ml-8">
                ...
                <h1 class="MBlackCondensed gap-1 items-end block text-[8vw] md:text-2m leading-none text-gray-50">
					<?php  echo _e(' TOTAL AREA: <br class="hidden md:block"><span class="number1 block w-[20vw] md:w-[12vw] text-[#aeb521] text-[12vw] md:text-[4vw] leading-none"> 7,111.01</span> HECTARES','dm'); ?>
    ...
    <div class="flex w-full md:px-0 md:w-1/2 flex-col justify-around">
        ...
        <div class="flex justify-end">
            <img width="842" height="478" class="w-11/12 mx-auto md:mx-0 md:w-[43.854vw]"
                src="<?php bloginfo('template_url'); ?><?php  echo _e('/img/CaboPulmo/mapaMxEN.svg','dm'); ?>" alt="" />
        </div>
        <div class="w-full rounded-l-3xl my-8 md:mt-0 bg-[#aeb521] rounded-r-3xl md:rounded-r-none px-2 md:px-6 py-2">
            <h1 class="MBlack text-[#4c7738] text-6m md:text-5xl leading-none text-center md:text-start">
				<?php  echo _e('DEPTHS OF BASALT BARS ON WHICH<br>CORALS SETTLE:','dm'); ?>
			</h1>
            <div class="flex mb-2 gap-2 md:gap-6 items-center mt-4 md:mt-0">
                ...
                <div class="text-gray-50">
                    <h1 class="text-[6.5vw] md:text-2m MBlackCondensed  leading-[6vw] md:leading-[3vw]">20 <?php  echo _e('METERS','dm'); ?></h1>
                    <h1 class="text-[3.6vw] md:text-4xl MBold leading-none"><?php  echo _e('MAXIMUM DEPTH','dm'); ?> <span
                            class="text-2m md:text-xl"><?php  echo _e('</br>(NORTHERN PORTION OF PARK)','dm'); ?></span></h1>
                </div>
                <div class="text-gray-50">
                    <h1 class="text-[6.5vw] md:text-2m MBlackCondensed  leading-[6vw] md:leading-[3vw]">2-3  <?php  echo _e('METERS','dm'); ?></h1>
                    <h1 class="text-[3.6vw] md:text-4xl MBold leading-none"><?php  echo _e('MINIMUM DEPTH ','dm'); ?><span
                            class="text-2m md:text-xl"><?php  echo _e('</br>(CENTRAL AND SOUTHERN PORTIONS)','dm'); ?></span></h1>
                </div>
            </div>
            ...
            <div class="mt-1 md:mt-4 ">
                <div class="flex gap-2 md:gap-6 items-cente text-gray-50 MBlackCondensed">
                    ...
                    <div class="">
                        ...
                        <h1 class="text-6m md:text-8xl leading-none"><?php  echo _e('MEAN ANNUAL TEMPERATURE','dm'); ?></h1>
                    </div>
                </div>
                <div class="flex gap-2 md:gap-6 items-cente text-gray-50 MBlackCondensed">
                    <img class="w-[11.5vw] md:w-[4.531vw] my-auto"
                    ...
                    <div class="">
                        <h1 class="text-[11vw] md:text-6m leading-none">214.33 mm</h1>
                        <h1 class="text-6m md:text-8xl leading-none"><?php  echo _e('AVERAGE ANNUAL RAINFALL','dm'); ?></h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="w-full  md:px-0 md:w-1/2">
        <div class="flex justify-start">
            <img width="877" height="1164" class="w-11/12 md:mx-0 md:w-[45.677vw]"
                src="<?php bloginfo('template_url'); ?><?php  echo _e('/img/CaboPulmo/mapaCaboPulmoEN.svg','dm'); ?>" alt="" />
        </div>
    </div>
</section>
...
<section data-aos="fade-up"
    ...
    <div class="flex flex-col items-center mt-2 md:mt-auto gap-2 md:gap-6">
        <div
            class="group buttonMeta flex w-11/12 md:w-[42.604vw] cursor-pointer justify-center md:justify-start items-center gap-2 rounded-3xl bg-secondary4 py-4 shadow-lg px-4">
    ...
    <div class="w-full md:w-[59.948vw]">
        ...
        <div class="bg-[#eff0d3] py-4 md:py-8 rounded-bl-none md:rounded-bl-3xl rounded-l-3xl px-4 md:px-0 md:pl-8">
            <h1
                ...
                <?php _e("TOURISM IN CABO PULMO", 'dm') ?>
            </h1>
            <div class="flex gap-4">
				...
				<?php _e("To guarantee a proper management for Cabo Pulmo National Park it is necessary to have data that allows managers to identify use patterns within the MPA. CONANP and tourism operators keep records of their activities, allowing them to monitor the health of marine ecosystems.", 'dm') ?></h1>
            </div>
        </div>
    </div>
    <div
        class="bg-[#eff0d3] w-full md:w-[35.313vw] md:rounded-bl-none rounded-b-3xl md:rounded-r-3xl pb-6 md:py4 flex items-center ">
        <a href=" <?php _e("https://public.tableau.com/app/profile/datamares/viz/CaboPulmoNationalParkdiversity/Terrestrialecosystems", 'dm') ?>" target="_blank"
            class="w-full rounded-r-3xl hover:scale-105 transition-transform flex items-center ">
...
<section data-aos="fade-up" class="mt-12 md:mt-28 w-11/12 md:w-[95.260vw] mx-auto md:flex">
    <div class="w-full md:w-[59.948vw]">
        ...
        <div class="bg-[#eff0d3] py-4 md:py-8 rounded-bl-none md:rounded-bl-3xl rounded-l-3xl px-4 md:px-0 md:pl-8">
            <h1
                class='MBlackCondensed text-[7vw] md:text-6m text-[#4c7738] leading-none mb-4 text-center md:text-start'>
                <?php _e("TERRESTRIAL BIODIVERSITY", 'dm') ?>
            </h1>
            <div class="flex gap-4">
                <img width="95" height="111" class="w-[15vw] md:w-[4.948vw]"
                    ...
                    alt="">
                <h1 class="text-6m md:text-5xl text-[#4c7738] leading-none">
				<?php _e("The terrestrial area bordering Cabo Pulmo NP includes four main habitats: arid scrub, desert dry scrub, dunes and riparian areas. Each of these habitats is home to a unique diversity of plant and animal species, several endemic to the region.", 'dm') ?>
				</h1>
            </div>
        </div>
    </div>
    <div
        class="bg-[#eff0d3] w-full md:w-[35.313vw] md:rounded-bl-none rounded-b-3xl md:rounded-r-3xl pb-6 md:py-4 flex items-center ">
                ...
                <div
                    ...
                    <div class="border-gray-50 border-4 p-2 rounded-2xl flex items-center gap-4">
                        <img width="47" height="47" class="w-[8vw] md:w-[2.448vw]"
                            src="<?php bloginfo('template_url'); ?>/img/CaboPulmo/cursor.svg" alt="">
                        <h1 class="MBlack text-9m md:text-xl text-gray-50"><?php _e("MARINE ECOTOURISM", 'dm') ?></h1>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a class="group" href="https://vimeo.com/163299942" target="_blank">
                ...
                <div
                    ...
                    <div class="border-gray-50 border-4 p-2 rounded-2xl flex gap-4 items-center">
                        <img width="47" height="47" class="w-[8vw] md:w-[2.448vw]"
                            src="<?php bloginfo('template_url'); ?>/img/CaboPulmo/cursor.svg" alt="">
                        <h1 class="MBlack text-9m md:text-xl text-gray-50"><?php _e("CP: A SUCCESS STORY", 'dm') ?></h1>
                    </div>
                </div>
            </a>
        </div>
            ...
            <a class="group"
                ...
                <div
                    ...
                    <div class="border-gray-50 border-4 p-2 rounded-2xl flex items-center gap-4">
                        <img width="47" height="47" class="w-[8vw] md:w-[2.448vw]"
                            src="<?php bloginfo('template_url'); ?>/img/CaboPulmo/cursor.svg" alt="">
                        <h1 class="MBlack text-9m md:text-xl text-gray-50"><?php _e("REPORT FROM EZCURRA LAB", 'dm') ?></h1>
                    </div>
                </div>
            </a>
        </div>

...
<h1 id='metTitle' style="width:stretch" class='text-gray-50  bg-[#4b626e] py-4 text-3xl 2xl:text-5xl isBlack m-auto ml-4 md:ml-auto mb-0 text-center' style="margin-bottom: 0 !important;"><?php _e("TRANSECTS", 'dm') ?></h1>
        ...
        <h1 id='t5' style="width: stretch;background: #CACFD3;" class='text-gray-50 py-4 meText text-3xl 2xl:text-5xl isBlack m-auto ml-4 md:ml-auto mb-0 text-center hidden cursor-pointer ' style="margin-bottom: 0 !important;"><?php _e("METHODOLOGY PCU", 'dm') ?></h1>
    ...
    <img id='met5' class='metImg hidden' src="<?php the_field('met5'); ?>" alt="">
    ...
    <?php if (have_rows('reefs')): ?>
        ...
        ?>
            <div class="flex flex-col justify-between">
                ...
                <a class='hidden cursor-pointer xl:flex' href="mailto:direccion@datamares.org">
                    <div
            ...
            <a class='flex cursor-pointer xl:hidden' href="mailto:direccion@datamares.org">
                <div
...
<script>
    ...
    AOS.init();
    document.addEventListener("aos:in:numbers", ({
        detail
    }) => {
    ...
    function ecologicalC() {
        $("#slides").slick({
            ...
            prevArrow: '<button class="slick-prev -left-11 slick-arrow absolute top-[3.3rem]" aria-label="Previous" type="button" style="z-index: 5;"><svg class="w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 41.6 40.94"><defs><style>.cls-1{fill:#FFFFFFc;}</style></defs><g id="Capa_2" data-name="Capa 2"><g id="Layer_1" data-name="Layer 1"><polygon class="cls-1" points="20.47 0 25.94 5.46 10.93 20.47 25.94 35.48 20.47 40.94 0 20.47 20.47 0"></polygon><polygon class="cls-1" points="36.13 0 41.59 5.46 26.59 20.47 41.59 35.48 36.13 40.94 15.66 20.47 36.13 0"></polygon></g></g></svg></button>',
            nextArrow: '<button class="slick-next -right-11 slick-arrow absolute top-[3.3rem]" aria-label="Next" type="button" style=""><svg class="icn-next w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 41.6 40.94"><defs><style>.cls-1{fill:#FFFFFF;}</style></defs><g id="Capa_2" data-name="Capa 2"><g id="Layer_1" data-name="Layer 1"><polygon class="cls-1" points="20.47 0 25.94 5.46 10.93 20.47 25.94 35.48 20.47 40.94 0 20.47 20.47 0"></polygon><polygon class="cls-1" points="36.13 0 41.59 5.46 26.59 20.47 41.59 35.48 36.13 40.94 15.66 20.47 36.13 0"></polygon></g></g></svg></button>',
        });
    }
    ...
    $('.metButton, #t5').click(function() {
        let text = $(this).hasClass('metButton') ? $(this).find('.metText').text() : $('#metTitle').text();
        ...
        if (id === 't4') {
            ...
            $('#tab1').css('border-left-color', '#4b626e !important');
            $('#metTitle').css('background-color', '#4b626e !important');
        }
    ...
    $('#metTitle').click(function() {
        if (!$('#met5').hasClass('hidden')) {
            $('.metImg').addClass('hidden');
            $('#met3').removeClass('hidden');
        }
    });
    ...
    function ecologicalCS() {
        $("#sponsorsMonitoring").slick({
            ...
            nextArrow: '<button class="slick-next -right-11 slick-arrow absolute top-[3.3rem]" aria-label="Next" type="button" style=""><svg class="icn-next w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 41.6 40.94"><g id="Capa_2" data-name="Capa 2"><g id="Layer_1" data-name="Layer 1"><polygon class=" fill-primary" points="20.47 0 25.94 5.46 10.93 20.47 25.94 35.48 20.47 40.94 0 20.47 20.47 0"></polygon><polygon class="fill-primary" points="36.13 0 41.59 5.46 26.59 20.47 41.59 35.48 36.13 40.94 15.66 20.47 36.13 0"></polygon></g></g></svg></button>',

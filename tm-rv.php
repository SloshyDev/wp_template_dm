            ...
            <div class="maps">
                ...
                <div class="hidden last:block m3">
                    <img width="877" height="1164" class="w-11/12 md:mx-0 md:w-[45.677vw]"
                        src="<?php _e("https://datamares.org/wp-content/uploads/2024/02/Asset-2.svg", 'dm' )?>" alt="" />
                </div>
                <div class="hidden last:block m4">
                    <img width="877" height="1164" class="w-11/12 md:mx-0 md:w-[45.677vw]"
                        src="<?php _e("https://datamares.org/wp-content/uploads/2024/02/Asset-3.svg", "dm" )?>" alt="" />
                </div>
				<div class="hidden last:block m1">
                    <img width="877" height="1164" class="w-11/12 md:mx-0 md:w-[45.677vw]"
                        src="<?php _e("https://datamares.org/wp-content/uploads/2024/02/Asset-4.svg", 'dm' )?>" alt="" />
                </div>
            </div>
        </div>
    </div>
...
<div data-aos="fade-up" class="bg-[#4c7738] py-16 px-8">
    ...
    <div class="flex justify-center" style="gap:3vw">
        <div class="">
            <a class="group" href="<?php _e("https://datamares.org/preview/dp_revillagigedo-national-park/", "dm") ?>" target="_blank">
                <img width="339" height="187" style="height:14vw; width:auto;"
                    class="shadow-xl mx-auto border-gray-50 border-4 rounded-xl group-hover:scale-105 transition-transform"
                    src="https://datamares.org/wp-content/uploads/2024/02/Recurso-10.png" alt="">
                <div
                    ...
                    <div class="border-gray-50 border-4 p-2 rounded-2xl flex items-center gap-4">
                        <img width="47" height="47" class="w-[8vw] md:w-[2.448vw]"
                            src="<?php bloginfo('template_url'); ?>/img/CaboPulmo/cursor.svg" alt="">
                        <h1 class="MBlack text-9m md:text-xl text-gray-50">dataPoster Revillagigedo</h1>
                    </div>
                </div>
            </a>
        </div>
        <div class="">
            <a class="group" href="https://www.science.org/doi/full/10.1126/sciadv.adg0709" target="_blank">
                <img width="339" height="187" style="height:14vw; width:auto;"
                    class=" shadow-xl mx-auto border-gray-50 border-4 rounded-xl group-hover:scale-105 transition-transform"
                    src="https://datamares.org/wp-content/uploads/2024/02/Recurso-11.png" alt="">
                <div style="width: 25.51vw;"
                    ...
                    <div class="border-gray-50 border-4 p-2 rounded-2xl flex gap-4 items-center">
                        <img width="47" height="47" class="w-[8vw] md:w-[2.448vw]"
                            src="<?php bloginfo('template_url'); ?>/img/CaboPulmo/cursor.svg" alt="">
                        <h1 class="MBlack text-9m md:text-xl text-gray-50">The largest fully protected marine area in North
America does not harm industrial fishing.</h1>
                    </div>
                </div>
            </a>
        </div>
		<div class="flex" style="gap:1vw">
            <a class="group" href="https://datamares.org/preview/dg_expedicion-revillagigedo-2023/?lang=es" target="_blank">
                <img height="350" style="height:14vw; width:auto;"
                    class="shadow-xl mx-auto border-gray-50 border-4 rounded-xl group-hover:scale-105 transition-transform"
                    src="https://datamares.org/wp-content/uploads/2024/04/dG-EXPEDICION-REVILLAGIGEDO.jpg" alt="">
                <div style="width: 13.51vw;"
                    class="w-11/12 group-hover:bg-[#aeb521] transition-colors  bg-secondary4 border-[#aeb521] border-8 mb-12 md:mb-auto mt-8 rounded-3xl mx-auto">
                    <div class="border-gray-50 border-4 p-2 rounded-2xl flex gap-4 items-center">
                        <img width="47" height="47" class="w-[8vw] md:w-[2.448vw]"
                            src="<?php bloginfo('template_url'); ?>/img/CaboPulmo/cursor.svg" alt="">
                        <h1 class="MBlack text-9m md:text-xl text-gray-50">dataGráfico EPNR</h1>
                    </div>
                </div>
            </a>
			<a class="group" href="https://revillagigedodashboard.org/revillagigedo-app/" target="_blank">
                <img height="350" style="height:14vw; width:auto;"
                    class="shadow-xl mx-auto border-gray-50 border-4 rounded-xl group-hover:scale-105 transition-transform"
                    src="https://datamares.org/wp-content/uploads/2025/01/Melissa_Revilla.jpg" alt="">
                <div style="width: 13.51vw;"
                    class="w-11/12 group-hover:bg-[#aeb521] transition-colors  bg-secondary4 border-[#aeb521] border-8 mb-12 md:mb-auto mt-8 rounded-3xl mx-auto">
                    <div class="border-gray-50 border-4 p-2 rounded-2xl flex gap-4 items-center">
                        <img width="47" height="47" class="w-[8vw] md:w-[2.448vw]"
                            src="<?php bloginfo('template_url'); ?>/img/CaboPulmo/cursor.svg" alt="">
                        <h1 class="MBlack text-9m md:text-xl text-gray-50">El Archipiélago de Revillagigedo</h1>
                    </div>
                </div>
            </a>
        </div>
...
">
			...
			<a href="https://simec.conanp.gob.mx/ficha.php?anp=82&reg=11"
                class="Mbold text-gray-50 text-9m text-center md:text-start md:text-4xl flex justify-center md:justify-start"
                target="_blank" rel="noopener noreferrer">
                • https://simec.conanp.gob.mx/<span class="hidden md:block">ficha.php?anp=82&amp;reg=11</span>
            </a>
			<a href="https://www.conanp.gob.mx/programademanejo/PMRevillagigedo.pdf"
                class="Mbold text-gray-50 text-9m text-center md:text-start md:text-4xl flex justify-center md:justify-start"
                target="_blank" rel="noopener noreferrer">
                • https://www.conanp.gob.mx/<span class="hidden md:block">programademanejo/PMRevillagigedo.pdf</span>
            </a>
			<h1 class='Mbold text-gray-50 text-9m text-center md:text-start md:text-4xl flex justify-center md:justify-start'>

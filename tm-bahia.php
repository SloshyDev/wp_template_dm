...
<section data-aos="fade-up" data-aos-id="number1" class="my-8 md:ml-4 md:flex justify-between" style="align-items:end;">
    <div class="w-[97%] mx-auto md:w-4/5 md:px-0">
        <div class="md:justify-start flex items-center gap-2 md:gap-4 md:ml-2 2xl:ml-8 mb-2">
            ...
            <h1 class="MBlackCondensed text-[5.5vw] md:text-4m text-[#4c7738]">
				<?php  echo _e('DATE ESTABLISHED: <span class="text-[#aeb521]">July 19, 1996</span>','dm'); ?>
            </h1>
        </div>
        <div class="flex items-center gap-[2vw] md:gap-4 xl:ml-2 2xl:ml-8">
            ...
            <h1 class="MBlackCondensed text-9m md:text-2m leading-none text-[#4C7738]">
               <?php  echo _e(' MANAGEMENT CATEGORY: <span class="text-[#aeb521]">NATIONAL PARK</span>','dm'); ?>
            </h1>
        </div>
        <div style="margin-bottom:0;"
            class="mt-2 w-fit md:w-auto px-[5vw] mx-auto md:px-0 md:mb-8 md:flex flex-col md:flex-row items-center justify-around md:justify-start gap-4 py-8 md:mr-[1vw] bg-[#4C7738] rounded-md">
            <div class="flex items-center gap-[2vw] md:gap-4 xl:ml-2 2xl:ml-8">
                <img class="w-[16vw] md:w-[4.7vw]" width="87" height="87"
                    src="<?php bloginfo('template_url'); ?>/img/CaboPulmo/superficie.svg" alt="" />
                <h1 class="MBlackCondensed gap-1 items-end block text-[8vw] md:text-2m leading-none text-gray-50" style="min-width: 16vw;">
                   <?php  echo _e('TOTAL AREA:','dm'); ?> <br class='hidden md:block'>
                    <span
                        class="number1 block w-[20vw] md:w-[12vw] text-[#aeb521] text-[12vw] md:text-[4vw] leading-none">
                        206,580.75
                    </span>
                    <?php  echo _e('HECTARES','dm'); ?>
                </h1>
            </div>
            <div class="flex items-center gap-4">
                ...
                <div class="">
                    ...
                    <h1 class="MBlackCondensed text-[8vw] uppercase md:text-3m leading-none text-gray-50">
                        <?php  echo _e('HECTARES IN<br />MARINE AREA','dm'); ?>
                    </h1>
                </div>
            </div>
            <div class="flex items-center gap-4">
                ...
                <div class="">
                    ...
                    <h1 class="MBlackCondensed text-[8vw] uppercase md:text-3m leading-none text-gray-50">
                        <?php  echo _e('HECTARES IN<br />TERRESTRIAL AREA','dm'); ?>
                    </h1>
                </div>
            </div>
        </div>
    ...
    <div class="flex w-full md:px-0 md:w-1/2 flex-col justify-between">
        <div class="flex items-center gap-4 xl:ml-2 2xl:ml-8">
            ...
            <h1 class="MBlackCondensed text-[5.5vw] md:text-4m text-[#4c7738] leading-none">
                <?php  echo _e(' GEOGRAPHIC LOCATION: </br> <span class="text-[#aeb521]">BAJA CALIFORNIA SUR</span>','dm'); ?>
            </h1>
        </div>
        <div class="flex justify-end">
            <img id="mpmx" width="842" height="478" class="w-11/12 mx-auto md:mx-0 md:w-[43.854vw]"
                src="<?php bloginfo('template_url'); ?><?php  echo _e('/img/CaboPulmo/mapaBLEN.svg','dm'); ?>" alt="" />
        </div>
        <div class="w-full rounded-l-3xl md:mt-0 bg-[#aeb521] rounded-r-3xl md:rounded-r-none px-2 md:px-6 py-2">
            <h1 class="MBlack text-[#4c7738] text-6m md:text-5xl leading-none text-center md:text-start"><?php  echo _e('ABOUT THE PARK’S BIODIVERSITY','dm'); ?>
            <div class="flex mb-2 gap-2 md:gap-6 items-center mt-4 md:mt-0">
                <img class="w-[11.5vw] md:w-[4.531vw] my-auto"
                    src="https://datamares.org/wp-content/uploads/2024/01/acerca.svg" alt="">
                <div class="text-gray-50">
                    <h1 class="text-6m md:text-4xl" style="font-weight: 400;">
					<?php  echo _e('According to CONABIO’s National Biodiversity Information
System, Loreto Bay NP is home to more than 1,300 animal and plant species, 80 of which are
under some type of protection category in Mexico’s protected specie list, NOM-059, and 18 are
introduced species. ','dm'); ?>
					</h1>
                </div>
            </div>
            ...
            <div class="mt-1 md:mt-4 ">
                <div class="flex gap-2 md:gap-6 items-cente text-gray-50 MBlackCondensed">
                    ...
                    <div class="">
                        <h1 class="text-[13vw] md:text-8m leading-none">26.02 °C</h1>
                        <h1 class="text-9m md:text-3m leading-none"><?php  echo _e('MEAN ANNUAL TEMPERATURE','dm'); ?></h1>
                    </div>
                </div>
                <div class="flex gap-2 md:gap-6 items-cente text-gray-50 MBlackCondensed">
                    <img class="w-[11.5vw] md:w-[4.531vw] my-auto"
                    ...
                    <div class="">
                        <h1 class="text-[13vw] md:text-8m leading-none">167.5 mm</h1>
                        <h1 class="text-9m md:text-3m leading-none"><?php  echo _e('AVERAGE ANNUAL RAINFALL','dm'); ?></h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="w-full  md:px-0 md:w-1/2">
        <div class="flex justify-start">
            <img width="877" height="1164" class="w-11/12 md:mx-0 md:w-[45.677vw]"
                src="<?php bloginfo('template_url'); ?>/img/CaboPulmo/<?php _e("zBLEN.svg", 'dm') ?>" alt="" />
        </div>
    </div>
</section>
                    ...
                    <?php while (have_rows('atractivos')):
                        ...
                        <li class="splide__slide flex flex-col py-8">
                            ...
                            <div class="mx-auto w-[75%] md:w-[16.8vw]">
                                <h1 class="MBlack text-7m md:text-3xl leading-none text-[#aeb521] mt-2">
...
<div data-aos="fade-up" data-aos-id="bar" class="bg-secondary4 py-12">
    <div class="MBlack mx-auto w-4/5 md:w-[45.208vw] text-center">
        <h1 class="text-9m md:text-1m leading-none text-gray-50"><?php _e("LEVEL OF PROTECTION", 'dm') ?></h1>
        <h1 class="text-5m md:text-2xl text-gray-50 leading-none">
            <?php _e("Mexico adopted the Convention on Nature Protection and Wildlife", 'dm') ?>
        </h1>
    </div>
	...
	<h1 class="text-[#4c7738] text-8xl absolute -mt-[6vw] ml-[13vw] MBlackCondensed">6,219.30 ha – <span
            class="text-9m">3.4%</span></h1>
    <div
    ...
    <div class="mx-[6vw] flex items-baseline justify-between">
        <div class="MBlackCondensed text-center">
            ...
            <h1 class="text-4xl leading-none text-gray-50"><?php _e("PROTECTION", 'dm') ?></h1>
        </div>
        <div class="MBlackCondensed text-center">
...
<section data-aos="fade-up"
    ...
    <div class="flex items-center justify-center md:justify-start gap-3 md:gap-6">
        <img width="143" height="168" class="w-[18vw] md:w-[7.448vw]"
            src="<?php echo $anpAzul ?>" alt="" />
        <h1 class="MBlackCondensed text-[7vw] md:text-8m text-[#4c7738]"><?php _e("MARINE BIODIVERSITY", 'dm') ?></h1>
    </div>
    <div class="flex flex-col items-center mt-2 md:mt-auto gap-2 md:gap-6">
        ...
        <div
            ...
            <a href="<?php _e("https://datamares.org/ecological_monitoring/", 'dm') ?>"
                class="MBlack text-[3.5vw] md:text-8xl text-gray-50 transition-colors group-hover:text-[#aeb521] text-start leading-none">
...
<section data-aos="fade-up" data-aos-id="number2"
    ...
    <div class="">
        <div class="flex justify-center md:justify-start gap-4 md:ml-6 mx-4 md:mx-0 pb-4 md:pb-12">
            ...
            <div class="text-gray-50">
                <h1 class="text-[6vw] md:text-1m MBlack leading-none"><?php _e("RELATIVE BIOMASS", 'dm') ?></h1>
                <h1 class="text-6m md:text-3xl md:w-[22.396vw] leading-none"><?php _e("Refers to the biomass of each trophic group with respect to the total biomass; it is expressed as a percentage.", 'dm') ?></h1>
            </div>
        </div>
        <div class="flex">
            <div class="w-3/5 md:w-[30.208vw] bg-gray-50 h-[20vw] md:h-[6.354vw] flex items-center">
                ...
                <div class=" MBlack text-[#007080]">
                    <h1 class="text-[6vw] md:text-1m leading-none"><span class="number3" ini="108">108</span> <span
                            class="text-6m md:text-5xl leading-none"><?php _e("REEFS", 'dm') ?></span></h1>
                    <h1 class="text-6m md:text-5xl leading-none "><?php _e("MONITORED", 'dm') ?></h1>
                </div>
            </div>
            <div
    ...
    <div class="w-3/4 md:w-auto mx-auto">
        <div class="flex gap-4 items-center justify-end">
            <h1 class="MBoldCondensed text-gray-50 text-8m md:text-5xl"><?php _e("PISCIVORES", 'dm') ?></h1>
            ...
            <div class="flex items-center w-[22.5vw] md:w-[11.979vw]">
                ...
                <h1 class="text-[10vw] md:text-9m MBlackCondensed leading-none text-gray-50"><span class="number2"
                        ini="12.5">12.5</span><span class="opacity-0 transition-opacity">%</span></h1>
            </div>

        </div>
        <div class="flex gap-4 items-center justify-end">
            <h1 class="MBoldCondensed text-gray-50 text-8m md:text-5xl"><?php _e("CARNIVORES", 'dm') ?></h1>
            <img width="56" height="56" class=" w-[8vw] md:w-[2.917vw]"
            ...
            <div class="flex items-center w-[22.5vw] md:w-[11.979vw]">
                ...
                <h1 class="text-[10vw] md:text-9m MBlackCondensed leading-none text-gray-50"><span class="number2"
                        ini="30.4">30.4</span><span class="opacity-0 transition-opacity">%</span></h1>
            </div>

        </div>
        <div class="flex gap-4 items-center justify-end">
            <h1 class="MBoldCondensed text-gray-50 text-8m md:text-5xl"><?php _e("HERBIVORES", 'dm') ?></h1>
            <img width="56" height="56" class=" w-[8vw] md:w-[2.917vw]"
            ...
            <div class="flex items-center w-[22.5vw] md:w-[11.979vw]">
                ...
                <h1 class="text-[10vw] md:text-9m MBlackCondensed leading-none text-gray-50"><span class="number2"
                        ini="35.7">35.7</span><span class="opacity-0 transition-opacity">%</span></h1>
            </div>

        </div>
        <div class="flex gap-4 items-center justify-end">
            <h1 class="MBoldCondensed text-gray-50 text-8m md:text-5xl"><?php _e("ZOOPLANKTIVORES", 'dm') ?></h1>
            <img width="56" height="56" class=" w-[8vw] md:w-[2.917vw]"
            ...
            <div class="flex items-center w-[22.5vw] md:w-[11.979vw]">
                ...
                <h1 class="text-[10vw] md:text-9m MBlackCondensed leading-none text-gray-50"><span class="number2"
                        ini="21.5">21.5</span><span class="opacity-0 transition-opacity">%</span></h1>
            </div>
...
<section data-aos="fade-up" data-aos-id="number3"
    ...
    <div class="">
        <div class="flex justify-center md:justify-start gap-4 md:ml-6 mx-4 md:mx-0 pb-4 md:pb-12">
            ...
            <div class="text-gray-50">
                <h1 class="text-[6vw] md:text-1m MBlack leading-none"><?php _e("RICHNESS", 'dm') ?></h1>
                <h1 class="text-6m md:text-3xl md:w-[22.396vw] leading-none"><?php _e("Total number of species in aspecific habitat, ecosystem, area or region.", 'dm') ?></h1>
            </div>
        </div>
        <div class="flex">
            <div
                class="w-3/5 md:w-[30.208vw] bg-gray-50 h-[22vw] md:h-[14.688vw] flex flex-col justify-center items-center ">
                <h1 class="text-[6vw] md:text-4m MBlack text-[#007080] leading-none"><?php _e("TOTAL RICHNESS", 'dm') ?></h1>
                <div class="flex items-center">
                    ...
                    <div class=" MBlack text-[#007080]">
                        ...
                        <h1 class="text-[8vw] md:text-8m leading-none number3" ini="239">239</h1>
                        <h1 class="text-[3vw] md:text-5xl leading-none "><?php _e("INVERTEBRATES
</br>AND FISHES", 'dm') ?>
                        </h1>
                    </div>
                </div>
    ...
    <div class="w-full md:w-[59.948vw]">
        <div class="bg-[#eff0d3] flex rounded-tr-3xl md:rounded-tr-none">
            <img width="415" height="118" class="w-[50vw] md:w-[21vw] py-4 md:py-0 px-8 bg-gray-50"
                src="<?php _e("https://datamares.org/wp-content/uploads/2024/01/consultaEN.svg", 'dm') ?>" alt="" />
            <div
...
"><?php _e("REQUEST DATA", 'dm') ?></h1></a>
        ...
        <div class="bg-[#eff0d3] py-4 md:py-8 rounded-bl-none md:rounded-bl-3xl rounded-l-3xl px-4 md:px-0 md:pl-8">
            <h1
                ...
                <?php _e("LORETO, SHARED VISION FOR 2050", 'dm') ?>
            </h1>
...
<div data-aos="fade-up" class="mt-6 md:mt-12 w-[95.260vw] mx-auto mb-12 md:mb-24">
    ...
    <a href="https://datamares.org/atlas-de-buceo/?lang=es">
        <img width="1830" height="501"
            ...
            src="<?php bloginfo('template_url'); ?><?php _e('/img/CaboPulmo/atlasEN.svg', 'dm') ?>" alt="">
    </a>
</div>
...
<div data-aos="fade-up" class="bg-[#4c7738] py-16 px-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-8 w-fit">
        <div class="">
            <a class="group" href="https://youtu.be/F4SJJOoD_dU?si=voTnQyFH0DZCiQNy" target="_blank">
                <img width="339" height="187"
                    ...
                    src="https://datamares.org/wp-content/uploads/2024/01/Recurso-1-1.png" alt="">
                <div
                    ...
                    <div class="border-gray-50 border-4 p-2 rounded-2xl flex items-center gap-4">
                        <img width="47" height="47" class="w-[8vw] md:w-[2.448vw]"
                            src="<?php bloginfo('template_url'); ?>/img/CaboPulmo/cursor.svg" alt="">
                        <h1 class="MBlack text-9m md:text-xl text-gray-50"> <?php _e("Species at risk", 'dm') ?></h1>
                    </div>
                </div>
            </a>
        </div>
...
<script src="<?php bloginfo('template_url'); ?>/js/bl.js"></script>
	<script>
	var options = {
    chart: {
        height: '100%',
